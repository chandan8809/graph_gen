...
const RadarChart = ({ tableData, onDownload }) => {
  ...
  useEffect(() => {
    ...
    // For radar charts, use multiple datasets
    let colorIndex = 0;
    ...
    const options = {
      ...
      plugins: {
        title: {
          display: true,
          text: 'Data Visualization (Radar Chart)'
        },
        legend: {
          position: 'top',
        }
  ...
  return (
    <div className="w-full mb-8">
      <div className="flex justify-between items-center mb-4">
        <h3 className="font-semibold">Radar Chart Visualization</h3>
        <button
