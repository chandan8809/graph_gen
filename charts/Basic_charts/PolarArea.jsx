...
const PolarAreaChart = ({ tableData, onDownload }) => {
  ...
  useEffect(() => {
    ...
    // For polar area charts, only use the first data row
    const data = [];
    ...
    const options = {
      ...
      plugins: {
        title: {
          display: true,
          text: 'Data Visualization (Polar Area Chart)'
        },
        legend: {
          position: 'top',
        }
  ...
  return (
    <div className="w-full mb-8">
      <div className="flex justify-between items-center mb-4">
        <h3 className="font-semibold">Polar Area Chart Visualization</h3>
        <button
